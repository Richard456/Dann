...
from core.train_mnist import train_mnist
...
src_data_loader, num_src_train = get_data_loader_weight(
    ...
    train=True, weights = source_weight)
...
dann = train_mnist(dann, params,  src_data_loader, src_data_loader_eval, num_src_train, device, logger)
