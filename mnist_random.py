...
from core.train_random import train_random
...
class Config(object):
    # params for path
    model_name = "mnist-random_fixcls"
...
dann = train_random(dann, params, src_data_loader, tgt_data_loader, tgt_data_loader_eval, device,logger)
